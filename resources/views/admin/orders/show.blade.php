...
<p class="muted">{{ $order->customer->name }} · {{ $order->farmer->stall_name }} · {{ $order->market->name }}</p>
...
<div class="row g-3 mt-2">
    ...
    <div class="col-lg-5">
        ...
        <div class="mt-3 d-flex gap-2 flex-wrap">
            <a class="btn btn-outline-ml btn-sm" href="{{ route('admin.users.show', $order->customer) }}">Customer</a>
